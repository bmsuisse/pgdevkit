...
-- delayed-retry pass, which runs after every non-delayed file (permissions
-- included) has already been attempted. See
-- test_apply_schema_reapplies_permissions_for_a_delayed_table.
